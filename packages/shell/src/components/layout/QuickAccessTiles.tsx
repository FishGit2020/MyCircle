...
const QUICK_ACCESS_ITEMS: QuickAccessItem[] = [
  ...
  { path: '/anniversary', labelKey: 'nav.anniversary' as any, color: 'bg-pink-50 text-pink-500', darkColor: 'dark:bg-pink-900/20 dark:text-pink-400', widgetId: 'anniversary', iconKey: 'anniversary' }, // eslint-disable-line @typescript-eslint/no-explicit-any
];
