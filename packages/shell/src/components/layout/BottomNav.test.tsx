...
describe('BottomNav', () => {
  ...
  it('reset restores default order', () => {
    ...
    const defaultOrder = ['/', '/weather', '/stocks', '/podcasts', '/bible', '/worship', '/notebook', '/baby', '/child-dev', '/flashcards', '/daily-log', '/files', '/ai', '/benchmark', '/immigration', '/library', '/family-games', '/doc-scanner', '/hiking', '/trips', '/polls', '/radio', '/interview', '/transit'];
