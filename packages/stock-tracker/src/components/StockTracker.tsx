        ...
        <div className="mb-8 stock-card-enter">
          ...
          <div className="mt-4 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('stocks.newsComingSoon')}</p>
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{t('stocks.newsDescription')}</p>
            </div>
          </div>
        </div>
      )}
