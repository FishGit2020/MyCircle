        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() => refetch()}
              disabled={loading}
              className="p-1 rounded text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
