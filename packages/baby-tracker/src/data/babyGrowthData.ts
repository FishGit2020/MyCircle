...
export const babyGrowthData: BabyGrowthWeek[] = [
  ...
  { week: 5,  fruit: 'sesame seed',     animal: 'tadpole',          vegetable: 'radish sprout',   lengthCm: 0.2,  weightG: 0.1,   lengthIn: 0.08,  weightOz: 0.004 },
  { week: 6,  fruit: 'lentil',          animal: 'ladybug',          vegetable: 'sweet pea',       lengthCm: 0.6,  weightG: 0.2,   lengthIn: 0.24,  weightOz: 0.007 },
  ...
  { week: 18, fruit: 'bell pepper',     animal: 'guinea pig',       vegetable: 'onion',           lengthCm: 14.2, weightG: 190,   lengthIn: 5.59,  weightOz: 6.7 },
  ...
  { week: 21, fruit: 'pomegranate',     animal: 'sugar glider',     vegetable: 'carrot',          lengthCm: 26.7, weightG: 360,   lengthIn: 10.51, weightOz: 12.7 },
  ...
  { week: 24, fruit: 'ear of corn',     animal: 'cottontail rabbit', vegetable: 'cucumber',        lengthCm: 30,   weightG: 600,   lengthIn: 11.81, weightOz: 21.16 },
  { week: 25, fruit: 'acorn squash',    animal: 'barn owl',         vegetable: 'rutabaga',        lengthCm: 34.6, weightG: 660,   lengthIn: 13.62, weightOz: 23.28 },
  { week: 26, fruit: 'large papaya',    animal: 'groundhog',        vegetable: 'scallion bunch',  lengthCm: 35.6, weightG: 760,   lengthIn: 14.02, weightOz: 26.81 },
  { week: 27, fruit: 'large pomelo',    animal: 'toy poodle',       vegetable: 'cauliflower',     lengthCm: 36.6, weightG: 875,   lengthIn: 14.41, weightOz: 30.86 },
  { week: 28, fruit: 'eggplant',        animal: 'red panda',        vegetable: 'large zucchini',  lengthCm: 37.6, weightG: 1005,  lengthIn: 14.8,  weightOz: 35.45 },
  { week: 29, fruit: 'butternut squash', animal: 'jackrabbit',      vegetable: 'acorn squash',    lengthCm: 38.6, weightG: 1153, lengthIn: 15.2,  weightOz: 40.67 },
  { week: 30, fruit: 'large cucumber',  animal: 'small cat',        vegetable: 'cabbage',         lengthCm: 39.9, weightG: 1319,  lengthIn: 15.71, weightOz: 46.52 },
  { week: 31, fruit: 'coconut',         animal: 'raccoon',          vegetable: 'napa cabbage',    lengthCm: 41.1, weightG: 1502,  lengthIn: 16.18, weightOz: 52.98 },
  { week: 32, fruit: 'small papaya',    animal: 'cocker spaniel',   vegetable: 'jicama',          lengthCm: 42.4, weightG: 1702,  lengthIn: 16.69, weightOz: 60.03 },
  { week: 33, fruit: 'pineapple',       animal: 'armadillo',        vegetable: 'celery stalk',    lengthCm: 43.7, weightG: 1918,  lengthIn: 17.2,  weightOz: 67.65 },
  { week: 34, fruit: 'cantaloupe',      animal: 'fox cub',          vegetable: 'savoy cabbage',   lengthCm: 45,   weightG: 2146,  lengthIn: 17.72, weightOz: 75.71 },
  { week: 35, fruit: 'honeydew melon',  animal: 'beagle puppy',     vegetable: 'kabocha squash',  lengthCm: 46.2, weightG: 2383,  lengthIn: 18.19, weightOz: 84.07 },
  { week: 36, fruit: 'crenshaw melon',  animal: 'otter',            vegetable: 'romaine lettuce', lengthCm: 47.4, weightG: 2622,  lengthIn: 18.66, weightOz: 92.5 },
  { week: 37, fruit: 'winter melon',    animal: 'koala',            vegetable: 'swiss chard',     lengthCm: 48.6, weightG: 2859,  lengthIn: 19.13, weightOz: 100.86 },
  { week: 38, fruit: 'small pumpkin',   animal: 'red fox',          vegetable: 'leek',            lengthCm: 49.8, weightG: 3083,  lengthIn: 19.61, weightOz: 108.76 },
  { week: 39, fruit: 'mini watermelon', animal: 'corgi',            vegetable: 'pumpkin',         lengthCm: 50.7, weightG: 3288,  lengthIn: 19.96, weightOz: 115.99 },
  { week: 40, fruit: 'watermelon',      animal: 'small lamb',       vegetable: 'large pumpkin',   lengthCm: 51.2, weightG: 3462,  lengthIn: 20.16, weightOz: 122.12 },
];
