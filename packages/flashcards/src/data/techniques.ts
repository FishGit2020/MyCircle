...
export const techniques: TechniqueCard[] = [
  ...
  { id: 'pat-04', front: 'Trigger: only 3 distinct values in array → what to consider?', back: 'Constant-space hashmap/counting is possible — O(1) space hashmap since only 3 keys. Don\'t default to two-pointers. Ask: "What\'s special about the constraints?"', category: 'algorithms', difficulty: 2 },
