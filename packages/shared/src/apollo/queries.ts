...
// ─── Baby Memory Journal — Milestone Events ───────────────────────
const MILESTONE_EVENT_FIELDS = gql`
  fragment MilestoneEventFields on MilestoneEvent {
    id
    childId
    title
    eventDate
...
export const GET_MILESTONE_EVENTS = gql`
  ${MILESTONE_EVENT_FIELDS}
  query GetMilestoneEvents($childId: String, $limit: Int) {
    milestoneEvents(childId: $childId, limit: $limit) {
      ...MilestoneEventFields
    }
  }
`;

export const ADD_MILESTONE_EVENT = gql`
  ${MILESTONE_EVENT_FIELDS}
...
export const UPDATE_MILESTONE_EVENT = gql`
  ${MILESTONE_EVENT_FIELDS}
...
export const DELETE_MILESTONE_EVENT = gql`
  mutation DeleteMilestoneEvent($id: ID!) {
    deleteMilestoneEvent(id: $id)
  }
`;

// ─── Baby Memory Journal — Journal Photos ────────────────────────
const JOURNAL_PHOTO_FIELDS = gql`
  fragment JournalPhotoFields on JournalPhoto {
    id
    childId
    photoUrl
    storagePath
...
export const GET_JOURNAL_PHOTOS = gql`
  ${JOURNAL_PHOTO_FIELDS}
...
export const ADD_JOURNAL_PHOTO = gql`
  ${JOURNAL_PHOTO_FIELDS}
...
export const DELETE_JOURNAL_PHOTO = gql`
  mutation DeleteJournalPhoto($id: ID!) {
    deleteJournalPhoto(id: $id)
  }
`;

// ─── Baby Memory Journal — Infant Achievements ───────────────────
const INFANT_ACHIEVEMENT_FIELDS = gql`
  fragment InfantAchievementFields on InfantAchievement {
    id
    childId
    milestoneId
    achievedDate
...
export const GET_INFANT_ACHIEVEMENTS = gql`
  ${INFANT_ACHIEVEMENT_FIELDS}
  query GetInfantAchievements($childId: String!) {
    infantAchievements(childId: $childId) {
      ...InfantAchievementFields
    }
  }
`;

export const ADD_INFANT_ACHIEVEMENT = gql`
  ${INFANT_ACHIEVEMENT_FIELDS}
...
export const UPDATE_INFANT_ACHIEVEMENT = gql`
  ${INFANT_ACHIEVEMENT_FIELDS}
...
export const DELETE_INFANT_ACHIEVEMENT = gql`
