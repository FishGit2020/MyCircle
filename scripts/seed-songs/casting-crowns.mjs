...
const SONGS = [
  {
    title: "Who Am I [INCOMPLETE - needs Bridge]",
...
[F#m]I am [E]Yours, I am [A]Yours`,
  ...
  {
    title: "Praise You in This Storm [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "E",
    format: "chordpro",
    content: `{Verse 1}
...
I will praise You in this [E]storm`,
  ...
  {
    title: "Scars in Heaven [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "F",
    format: "chordpro",
    content: `{Verse 1}
...
[Dm]And all the old made [Bb]new`,
  ...
  {
    title: "Thrive [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "G",
    format: "chordpro",
    content: `{Verse 1}
...
[Em]And we're gonna [C]thrive`,
  ...
  {
    title: "Just Be Held [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "Bb",
    format: "chordpro",
    content: `{Verse 1}
...
[Gm]And just be [Eb]held`,
  ...
  {
    title: "One Step Away [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "A",
    format: "chordpro",
    content: `{Verse 1}
...
[F#m]One step a[D]way`,
  ...
  {
    title: "Nobody [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "C",
    format: "chordpro",
    content: `{Verse 1}
...
[Am]You gave my heart a [F]song to sing`,
  ...
  {
    title: "Healer [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "D",
    format: "chordpro",
    content: `{Verse 1}
...
[Bm]I believe You're more [G]than enough for me`,
  ...
  {
    title: "Great Are You Lord (CC) [INCOMPLETE - needs V2+Bridge]",
    artist: "Casting Crowns",
    originalKey: "D",
    format: "chordpro",
    content: `{Verse 1}
