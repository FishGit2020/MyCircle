#!/usr/bin/env node
/**
 * Seed: Jesus Messiah by Chris Tomlin/Daniel Carson/Ed Cash/Jesse Reeves
 * Usage: GOOGLE_APPLICATION_CREDENTIALS=./key.json node scripts/seed-songs/song-jesus-messiah.mjs --skip-existing
 */
